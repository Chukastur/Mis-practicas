...
AddCategory.propTypes = {                               // Asigna un objeto de validación de props al componente AddCategory
    onNewCategory: PropTypes.func.isRequired,           // Define que la prop 'onNewCategory' debe ser una función y es obligatoria
}